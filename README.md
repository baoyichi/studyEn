...
面向《新概念英语第一册》Lesson 73–143 的有课文单元（单数课）打造的个人学习网站，帮助建立“听得懂、译得准、说得出”的日常学习节奏。

## 功能

- **听力 + 跟读**：使用公开 YouTube 英文朗读音频，支持播放、暂停与 0.5×、0.8×、1×、1.25× 倍速。
- **课文阅读**：默认隐藏正文；可在英文原文与中文译文间切换。内容按课从原书页面裁切，避免展示整份 PDF。
- **汉译英**：仅显示当前 Lesson 中、且对应个人高频错因的原文专项句；若本课没有匹配句，不从其他课补题。每条都有独立输入框，句式重点和英文原文默认隐藏，点击眼睛图标后显示。
- **本地保存**：汉译英答案和日历打卡信息均保存在浏览器 `localStorage`，再次进入同一课会自动回显。
- **学习日历**：从 2026-09-01 至 2026-10-12，工作日与周六安排有原文的 Lesson 73、75…143；周日仅进行“错题复习”打卡。
